...
import com.example.ket.cryptomessage.Adapter.ListUsersAdapter;
...
public class ListUsersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lstUsers.setChoiceMode(CHOICE_MODE_MULTIPLE);
    ...
    private void createGroupChat(SparseBooleanArray checkedItemPositions) {
        ...
        QBRestChatService.createChatDialog(dialog).performAsync(new QBEntityCallback<QBChatDialog>() {
            ...
            public void onSuccess(QBChatDialog qbChatDialog, Bundle bundle) {
                mDialog.dismiss();;
                Toast.makeText(getBaseContext(),"Create chat dialog successfuly",Toast.LENGTH_SHORT).show();
                finish();
            }
        ...
        for(int i=0;i<countChoice;i++)
        {
            if(checkedItemPositions.get(i))
            {
                ...
                QBRestChatService.createChatDialog(dialog).performAsync(new QBEntityCallback<QBChatDialog>() {
                    ...
                    public void onSuccess(QBChatDialog qbChatDialog, Bundle bundle) {
                        mDialog.dismiss();
                        Toast.makeText(getBaseContext(),"Create private chat dialog successfuly",Toast.LENGTH_SHORT).show();
                        finish();
                    }
