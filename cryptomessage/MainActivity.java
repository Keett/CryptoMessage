...
public class MainActivity extends AppCompatActivity {
    ...
    static final String APP_ID="70719";
    static final String AUTH_KEY="sBX7ZE9jswbjOMX";
    static final String AUTH_SECRET="djn8f7ULVeCdYbn";
    static final String ACCOUNT_KEY="PisSfhCXCk6gv9C-M5jt";
            ...
            public void onClick(View view) {
                ...
                QBUsers.signIn(qbUser).performAsync(new QBEntityCallback<QBUser>() {
                    ...
                    public void onSuccess(QBUser qbUser, Bundle bundle) {
                        Toast.makeText(getBaseContext(),"Login successfuly",Toast.LENGTH_SHORT).show();
